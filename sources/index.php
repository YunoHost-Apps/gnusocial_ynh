...
function getPath($req)
{
    ...
    // Trim all initial '/'
    $p = ltrim($p, '/');
    /* Trim final '/' needed for .well-known/webfinger/?resource= */
    /* @see https://ostatus.shnoulle.net/conversation/542520#notice-553601 */
    if(strpos($p,".well-known/webfinger/")!==false || strpos($p,".well-known/hostmeta/")!==false){
        $p = rtrim($p, '/');
    }
    return $p;
}
